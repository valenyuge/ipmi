//Valentin Yuge 92715/7 Comision 3 TP2
...
void draw() {
  ...
  if (estado.equals("inicio")) {
    ...
    textSize(30);
    fill(0);
    text("'Rain Room' - Hannes Koch and Florian Ortkrass Random International", width + imgX - img1.width/2, height - 50);
    if (imgX > -img1.width) {
      imgX -= 2;
    } else {
      timer++;
    ...
    textSize(30);
    fill(0);
    text("Esta obra permita a los visitantes caminar a traves del agua sin mojarse.", width + imgX - img2.width/2, height - 50);
    if (imgX > -img2.width) {
      imgX -= 2;
    } else {
      timer++;
    ...
    textSize(30);
    fill(0);
    text("Los sensores de movimiento de la obra detectan a los visitantes para lograrlo", width + imgX - img3.width/2, height - 50);
    if (imgX > -img3.width) {
      imgX -= 2;
    } else {
      timer++;
